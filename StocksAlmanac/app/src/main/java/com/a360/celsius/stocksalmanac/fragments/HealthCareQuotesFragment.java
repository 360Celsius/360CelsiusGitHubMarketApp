...
public class HealthCareQuotesFragment extends BaseFragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        mSwipeRefreshLayout = (SwipeRefreshLayout) view.findViewById(R.id.healthcare_swipe_refresh_layout);
