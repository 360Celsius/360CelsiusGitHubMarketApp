...
public class UtilitiesQuotesFragment extends BaseFragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        listView=(ListView)view.findViewById(R.id.utilities_data_list);


        mSwipeRefreshLayout = (SwipeRefreshLayout) view.findViewById(R.id.utilities_swipe_refresh_layout);
