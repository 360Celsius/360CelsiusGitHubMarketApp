...
public class GoodsQuotesFragment extends BaseFragment {


    @Nullable
    @Override
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.fragment_goods_quotes, container, false);

        // Inflate the layout for this fragment
        //container.clearDisappearingChildren();


        listView=(ListView)view.findViewById(R.id.goods_data_list);


        mSwipeRefreshLayout = (SwipeRefreshLayout) view.findViewById(R.id.goods_swipe_refresh_layout);
